...
ggplot(ks_turkey, aes(x = Date, y = Total_Sales)) +
  ...
  scale_x_date(date_breaks = "2 years", date_labels = "%Y") +
  scale_y_continuous(labels = label_comma(accuracy = 1)) +
  labs(title = "Figure 4. Monthly Housing Sales – Türkiye",
       x = NULL, y = "Units Sold") +
  theme_minimal(base_size = 11)
```

Sales volumes show strong seasonality but have not risen with prices. Post-2022 softening is consistent with buyers being priced out of the market as affordability deteriorated.
