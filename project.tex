...
\subsection{2.3 Potential Analyses}\label{potential-analyses}
...
\subsection{2.4 Reason of Choice}\label{reason-of-choice}
...
\subsection{2.5 Preprocessing}\label{preprocessing}
...
\subsection{3.3 Correlation Analysis}\label{correlation-analysis}
...
\subsection{3.4 Regional Comparison}\label{regional-comparison}
...
\subsection{3.5 Model Fitting}\label{model-fitting}
...
\subsection{3.6 Results}\label{results}
